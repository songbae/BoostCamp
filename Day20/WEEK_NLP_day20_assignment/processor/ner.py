...
class NaverNerProcessor(object):
    ...
    def get_labels(self):
        return ['FD-B',  'EV-I', 'AM-I',  'MT-B', 'MT-I',  'PT-B', 'TM-B', 'EV-B', 'CV-B', 'TM-I', 'FD-I',
  'TR-B',  'CV-I',  'AF-I', 'PT-I',  'AM-B', 'TR-I',  'AF-B',  'DT-B','PS-B','TI-I','QT-I', 'O','LC-I','LC-B','OG-B','DT-I','TI-B','QT-B','OG-I','PS-I',]
...
class CustomNerProcessor(object):
    """Processor for the Custom NER data set """

    def __init__(self, args):
        self.args = args

    def get_labels(self):
        return ['DT-B','DT-I','LC-B','LC-I','OG-B','OG-I','PS-B','PS-I','QT-B','QT-I','TI-B','TI-I','O']
